...
class CustomTextInputField extends StatefulWidget {
  ...
  CustomTextInputField(
      ...
      this.labelText,
      this.fillColor = ColorManager.inputFieldBGColor,
                ...
                child: Text(widget.labelText!,
                    style: widget.istitleBold!
                        ? Theme.of(context).textTheme.titleMedium?.copyWith(
                            ...
                            color: ColorManager.labelsTextColor)
                        : Theme.of(context)
                            .textTheme
                            .titleMedium
          ...
          children: [
            TextFormField(
              style: Theme.of(context)
                  .textTheme
                  .titleSmall!
                  .copyWith(color: widget.textColor ?? ColorManager.black),
              obscureText: widget.obscureText,
              textAlign: widget.textAlign ?? TextAlign.start,
              maxLength: widget.maxLength,
              cursorColor: widget.hintTextColor ?? ColorManager.black,
              ...
              decoration: InputDecoration(
                fillColor: widget.enabled
                    ? widget.fillColor
                    : ColorManager.inputFieldBGColor,
                filled: true,
                errorMaxLines: 8,
                helperMaxLines: 8,
                ...
                errorBorder: OutlineInputBorder(
                  borderRadius:
                      BorderRadius.circular(widget.borderRadius ?? AppSize.s16),
                  borderSide:
